...
public class CharacterController2D : MonoBehaviour
{
	...
	// controlled jump
	public float jumpEndEarlyForce = 100f;
	...
	private void Update()
	{
		...
		// track when was last on ground for coyote time
		if(wasGrounded) {
	...
	public void Move(float move, bool crouch, bool jump, bool holdingJump)
	{
		...
		if (m_Grounded || m_AirControl)
		{
			...
			// If the input is moving the player diff direction than player is facing..
		...
		if(!holdingJump) {
			...
			// Add downward force for controlled jump
			m_Rigidbody2D.AddForce(new Vector2(0f, -jumpEndEarlyForce));
		}
	}
